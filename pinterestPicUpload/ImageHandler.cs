...
namespace PinBot
{
    public class ImageHandler
    {
        ...
        public int height
        {
            get { return _currentBitmap.Height; }
        }
        public int width
        {
            get { return _currentBitmap.Width; }
        }
        ...
        public void InsertImage(Bitmap image, int xPosition, int yPosition)
        {
            Image imageBackground = new Bitmap(_currentBitmap);
            Image imageOverlay = new Bitmap(image);
            ...
            using (Graphics gr = Graphics.FromImage(img))
            {
                ...
                //FETCH FROM WATER_MARK SETTINGS WHERE TO DRAW THE IMAGE #^^)
                gr.DrawImage(imageOverlay, new Point(xPosition, yPosition));
            }
